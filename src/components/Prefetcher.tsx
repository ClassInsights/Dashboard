        ...
        <div className="flex flex-col items-center pb-20 text-center">
          ...
          <p className="w-3/4 pb-5 lg:w-1/2">
            ...
            <Button variant="link" className="m-0! p-0!">
              <a
                href={`mailto:office@classinsights.at?subject=Dashboard%20Crash&body=Bitte%20beschreiben%20Sie%20den%20Fehlerzeitpunkt%20und%20sonstige%20Besonderheiten%0A%0A%0A%0AINFORMATIONEN%20UND%20FEHLER%20NICHT%20ENTFERNEN%0A__________________________________________%0A%0AInformationen%3A%0ASchule:%20${school.name}%0ASchul-ID:%20${school.id}%0AAPI-Url:%20${school.apiUrl}%0ADashboard-Url:%20${school.dashboardUrl}%0ADashboard-Version:%20${import.meta.env.PACKAGE_VERSION}%0A%0AFehlerdetails%3A%0A${[
                  computers.error,
                  rooms.error,
                  config.error,
                ]
